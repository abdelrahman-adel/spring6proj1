 ...
 * 
 * You can customize and add your methods here and the engine of spring will
 * guess and generate the methods for you without implmenting them yourself,
 * check below methods as a reference.
 * 
 * @author Abd-Elrahman Adel
 *
 */
public interface PersonSpringDataImplicitCustomeRepository extends JpaRepository<Person, Integer> {
